// Crie o arquivo ViewModels/MinhasComprasVM.cs
...
{
    public class MinhasComprasVM : BaseVM
    {
        ...
        public MinhasComprasVM(CompraService compraService)
        {
        ...
        public void CarregarMinhasCompras()
        {
            ...
            var compras = _compraService.GetComprasPorUsuario(usuarioLogado.UserId);
